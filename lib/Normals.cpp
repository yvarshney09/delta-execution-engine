...
double NormalProbabilityDensity::NormalDensity(double x)
{
    return OneOverRootTwoPi*exp(-x*x/2);
}

double NormalProbabilityDensity::InverseCumulativeNormal(double u)
{
...
double NormalProbabilityDensity::CumulativeNormal(double x)
{
